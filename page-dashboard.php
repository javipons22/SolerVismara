...
<div class="pag-inmuebles container">
    <aside class="buscador-aside">
        <a class="link-subir" href="<?php echo get_site_url(); ?>/upload">CARGAR INMUEBLE AL SISTEMA</a>
			...
			<?php if( $the_query2->have_posts() ): ?>
				...
				<li class="propiedad-reciente">
					...
					<div class="propiedad-reciente__contenido">
						...
						<a class="propiedad-reciente__borrar" href="<?php echo get_site_url(); ?>/dashboard-handler?action=borrar&id=<?php echo get_the_ID(); ?>">QUITAR DE DESTACADOS</a>
					</div>
				</li>
			<?php endwhile; endif;?>
			</ul>
				...
				<div class="propiedad__info">
					...
					<div class="propiedad__fecha">
						<?php if (count($destacados_array) < 4 && !in_array(get_the_ID(), $destacados_array) ) :?>
							<a class="propiedad__destacar" href="<?php echo get_site_url(); ?>/dashboard-handler?action=agregar&id=<?php echo get_the_ID(); ?>">Destacar</a>
						<?php endif;?>
                        <a class="propiedad__modificar" href="<?php echo get_site_url(); ?>/edit?id=<?php echo get_the_ID(); ?>">Modificar</a>
                        <a class="propiedad__borrar" href="<?php echo get_site_url(); ?>/delete?id=<?php echo get_the_ID(); ?>">Eliminar</a>
